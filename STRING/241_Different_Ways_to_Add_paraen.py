...
# The test cases are generated such that the output values 
# fit in a 32-bit integer and the number of different results does not exceed 104.
...
S = Solution().diffwaysToCompute("2-1-1")
print(S)