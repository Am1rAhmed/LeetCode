...
#     by pushing them. For example, the key 2 is mapped with ["a","b","c"], 
...
# An example mapping of letters to keys on a telephone keypad is 
# given below. Note that 1, *, #, and 0 do not map to any letters.
...
S = Solution().minimumPushes("xycdefghij")
print(S)