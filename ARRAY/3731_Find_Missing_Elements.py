...
# so the full range should be [1,2,3,4,5]. Among these, only 3 is missing.
...
# so the full range is [6,7,8,9]. All integers are already present, 
...
# The smallest integer is 1 and the largest is 5, 
# so the full range should be [1,2,3,4,5]. The missing integers are 2, 3, and 4.
...
S = Solution().findMissingElements([7,8,6,9])
print(S)