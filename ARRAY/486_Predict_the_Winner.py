...
# end of the array (i.e., nums[0] or nums[nums.length - 1]) 
# which reduces the size of the array by 1. The player adds 
# the chosen number to their score. The game ends when there 
# are no more elements in the array.

# Return true if Player 1 can win the game. If the scores of 
# both players are equal, then player 1 is still the winner, 
# and you should also return true. You may assume that both 
...
S = Solution().PredictTheWinner([1, 5, 233, 7])
print(S)  